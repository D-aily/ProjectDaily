				...
				<div class="container border border-primary"
					...
					<div class="row" id="searchBar">
						...
						<select class="form-select form-select"
							...
							id="costsearch">
							<option value="n" <c:out value="${pageMaker.page.costsearch==null ? 'selected':''}"/>>가격대 선택</option>
							<option value="c1" <c:out value="${pageMaker.page.costsearch=='c1' ? 'selected':''}"/>>10000만원~30000원만</option>
							<option value="c2" <c:out value="${pageMaker.page.costsearch=='c2' ? 'selected':''}"/>>30000만원~40000만원</option>
							<option value="c3" <c:out value="${pageMaker.page.costsearch=='c3' ? 'selected':''}"/>>40000만원~50000만원</option>
							<option value="c4" <c:out value="${pageMaker.page.costsearch=='c4' ? 'selected':''}"/>>50000만원이상</option>
						</select> <br> <br>
						...
						<select class="form-select form-select"
							...
							id="kindsearch">
							<option value="n" <c:out value="${pageMaker.page.kindsearch==null ? 'selected':''}"/>>종류 선택</option>
							<option value="k1" <c:out value="${pageMaker.page.kindsearch=='k1' ? 'selected':''}"/>>상의</option>
							<option value="k2" <c:out value="${pageMaker.page.kindsearch=='k2' ? 'selected':''}"/>>하의</option>
							<option value="k3" <c:out value="${pageMaker.page.kindsearch=='k3' ? 'selected':''}"/>>아우터</option>
							<option value="k4" <c:out value="${pageMaker.page.kindsearch=='k4' ? 'selected':''}"/>>가방</option>
						</select> <br> <br>
						...
						<select class="form-select form-select"
							...
							id="scoresearch">
							<option value="n" <c:out value="${pageMaker.page.scoresearch==null ? 'selected':''}"/>>평점</option>
							<option value="s1" <c:out value="${pageMaker.page.scoresearch=='s1' ? 'selected':''}"/>>1점</option>
							<option value="s2" <c:out value="${pageMaker.page.scoresearch=='s2' ? 'selected':''}"/>>2점</option>
							<option value="s3" <c:out value="${pageMaker.page.scoresearch=='s3' ? 'selected':''}"/>>3점</option>
							<option value="s4" <c:out value="${pageMaker.page.scoresearch=='s4' ? 'selected':''}"/>>4점</option>
							<option value="s5" <c:out value="${pageMaker.page.scoresearch=='s5' ? 'selected':''}"/>>5점</option>
						</select>
